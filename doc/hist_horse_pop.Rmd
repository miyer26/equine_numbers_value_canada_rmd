...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1. The histroical horse population in each province in Canada. It has been on a decline since the 1940s.", out.width='100%'}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
kable(max_horses, caption = "Table 1. Range of number of horses in each province between 1940-1972")
```

Below we zoom in and look at the province of Alberta:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Figure 2. Historical population of horses in Alberta.", out.width='100%'}
