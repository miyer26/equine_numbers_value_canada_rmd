...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = 'The histroical horse population in each province in Canada. It has been on a decline since the 1940s.'}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap = 'Historical population of horses in Alberta.'}
